...
namespace _2ndAsset.Utilities.DataObfu.WindowsTool.Controls
{
	partial class AdapterSettingsUserControl
	{
		...
		private void InitializeComponent()
		{
			...
			this.adoNetAdapterSettingsUc = new _2ndAsset.Utilities.DataObfu.WindowsTool.Controls.AdoNetAdapterSettingsUserControl();
			this.delTxtAdapterSettingsUc = new _2ndAsset.Utilities.DataObfu.WindowsTool.Controls.DelTxtAdapterSettingsUserControl();
