...
namespace _2ndAsset.Utilities.DataObfu.WindowsTool.Forms
{
	partial class ObfuscationForm
	{
		...
		private void InitializeComponent()
		{
			...
			this.avalancheSettingsUc = new _2ndAsset.Utilities.DataObfu.WindowsTool.Controls.AvalancheSettingsUserControl();
			this.tpSource = new System.Windows.Forms.TabPage();
			this.sourceAdapterSettingsUc = new _2ndAsset.Utilities.DataObfu.WindowsTool.Controls.AdapterSettingsUserControl();
			this.tpDictionaries = new System.Windows.Forms.TabPage();
			this.dictionarySettingsUc = new _2ndAsset.Utilities.DataObfu.WindowsTool.Controls.DictionarySettingsUserControl();
			this.tpMetadata = new System.Windows.Forms.TabPage();
			this.tpDestination = new System.Windows.Forms.TabPage();
			this.destinationAdapterSettingsUc = new _2ndAsset.Utilities.DataObfu.WindowsTool.Controls.AdapterSettingsUserControl();
			this.tpExecution = new System.Windows.Forms.TabPage();
			this.executionUc = new _2ndAsset.Utilities.DataObfu.WindowsTool.Controls.ExecutionUserControl();
			this.metadataSettingsUc = new _2ndAsset.Utilities.DataObfu.WindowsTool.Controls.MetadataSettingsUserControl();
