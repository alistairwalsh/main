...
"%GACUTIL_EXE%" -i "%TM_LIB_ASM_DIR%\%TM_COMMON_CORE_ASM_DLL_NAME%"
IF %ERRORLEVEL% NEQ 0 GOTO pkgError

"%GACUTIL_EXE%" -i "%TM_LIB_ASM_DIR%\%TM_COMMON_DATA_ASM_DLL_NAME%"
IF %ERRORLEVEL% NEQ 0 GOTO pkgError

"%GACUTIL_EXE%" -i "%TM_LIB_ASM_DIR%\%TM_COMMON_WINFORMS_ASM_DLL_NAME%"
IF %ERRORLEVEL% NEQ 0 GOTO pkgError

"%GACUTIL_EXE%" -i "%SA_CORE_ASM_DIR%\%SA_CORE_ASM_DLL_NAME%"
IF %ERRORLEVEL% NEQ 0 GOTO pkgError

"%GACUTIL_EXE%" -i "%SA_SSIS_COMPONENTS_ASM_DIR%\%SA_SSIS_COMPONENTS_ASM_DLL_NAME%"
IF %ERRORLEVEL% NEQ 0 GOTO pkgError

"%GACUTIL_EXE%" -i "%SA_SSIS_COMPONENTS_IU_ASM_DIR%\%SA_SSIS_COMPONENTS_IU_ASM_DLL_NAME%"
IF %ERRORLEVEL% NEQ 0 GOTO pkgError




copy "%SA_SSIS_COMPONENTS_ASM_DIR%\%SA_SSIS_COMPONENTS_ASM_DLL_NAME%" "%DTSx64_PLC_DIR%\."
IF %ERRORLEVEL% NEQ 0 GOTO pkgError

copy "%SA_SSIS_COMPONENTS_ASM_DIR%\%SA_SSIS_COMPONENTS_ASM_DLL_NAME%" "%DTSx32_PLC_DIR%\."
IF %ERRORLEVEL% NEQ 0 GOTO pkgError




copy "%SA_SSIS_COMPONENTS_IU_ASM_DIR%\%SA_SSIS_COMPONENTS_IU_ASM_DLL_NAME%" "%DTSx64_PLC_DIR%\."
IF %ERRORLEVEL% NEQ 0 GOTO pkgError

copy "%SA_SSIS_COMPONENTS_IU_ASM_DIR%\%SA_SSIS_COMPONENTS_IU_ASM_DLL_NAME%" "%DTSx32_PLC_DIR%\."
IF %ERRORLEVEL% NEQ 0 GOTO pkgError
